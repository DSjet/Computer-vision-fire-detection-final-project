...
model = load_model(configuration_fire.MODEL_PATH)
lb = pickle.loads(open(configuration_fire.ENCODER_PATH, "rb").read())
...
for (x, y, w, h) in rects[:configuration_fire.MAX_PROPOSALS_INFER]:
